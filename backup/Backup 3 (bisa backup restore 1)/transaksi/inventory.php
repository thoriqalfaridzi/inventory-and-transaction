...
while ($result = mysqli_fetch_assoc($sql)) {
    ...
    echo '<td>' . $result['kode_supplier_item'] . '</td>';
  ...
  <a href="prosesinventory/prosesinventory.php?hapus=' .$result['id_item'].'" type="button" onClick="return confirm(\'Apakah anda yakin ingin menghapus data <?php echo $result[\'nama_item\']; ?> tersebut???\')" style="text-decoration: none;">
