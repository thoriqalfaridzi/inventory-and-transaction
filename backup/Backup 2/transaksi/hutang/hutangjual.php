...
<input type="text" id="searchInputsupplier" placeholder="Search by Member" />
<table>
    <thead>
    <tr>
    ...
    $hutang_belum_terbayar = $resulttable['harga_jual'] - $resulttable['hutang_terbayar'];
        ...
        <tr>
            ...
            <td ><?php echo $resulttable['hutang_terbayar']; ?></td>
            <td ><?php echo $hutang_belum_terbayar; ?></td>

            <td style="text-align: center;" class="no-print">
                <a href="kelolahutang/kelolahutangjual.php?ubah=<?php echo $resulttable['id']; ?>" type="button"
