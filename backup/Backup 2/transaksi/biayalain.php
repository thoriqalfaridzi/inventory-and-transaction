...
while ($resultadd = mysqli_fetch_assoc($sqladd)) {
    ...
    ?>
            ...
            <td class="namaBarang"><?php echo $resultadd['biayalain']; ?></td>

            <td style="text-align: center;">
              <a href="kelolasatuan.php?ubah=<?php echo $result['id']; ?>" type="button" style="text-decoration: none;">
                <img src="../IconImage/editimg.png" style="width: 20px; height: 20px;">
              </a>
              <a href="prosesaddbiaya.php?hapus=<?php echo $result['id']; ?>" type="button" onClick="return confirm('Apakah anda yakin ingin menghapus data <?php echo $result['bulan']; echo $result['tahun']; ?> tersebut???')" style="text-decoration: none;">
