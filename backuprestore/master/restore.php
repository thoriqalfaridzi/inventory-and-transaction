...
function restoreDatabase($host, $user, $pass, $name, $file)
{
    ...
    $mysqli->query("DELETE FROM master_item");
    $mysqli->query("DELETE FROM master_kategori");
    $mysqli->query("DELETE FROM master_member");
    $mysqli->query("DELETE FROM master_satuan");
    $mysqli->query("DELETE FROM master_seller");
    $mysqli->query("DELETE FROM master_supplier");
...
if (isset($_POST['restore'])) {
    ...
    if (isset($_FILES['sql_file']) && $_FILES['sql_file']['error'] === UPLOAD_ERR_OK) {
        ...
        restoreDatabase($host, $user, $pass, $name, $file_tmp);
    } else {
