<header>
    <a href="#" class="logo">DJAYA BERKAT MOTOR</a>
    <ul>
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="../../Master/MasterSeller.php">Master Sales</a>
            </div>
        </li>
        <li class="dropdown">
            <a href="#">Transaksi</a>
        ...
        <li class="dropdown">
            <a href="#"  class="active">Backup & Restore</a>
            <div class="dropdown-content">
                <a href="../transaksi/back.php">Backup Penjualan</a>
                <a href="../transaksi/restore.php">Restore Penjualan</a>
                <a href="back.php">Backup Master</a>
                <a href="restore.php">Restore Master</a>
            </div>
        </li>
