<header>
    ...
    <ul>
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="back.php">Backup Penjualan</a>
                <a href="restore.php">Restore Penjualan</a>
                <a href="../master/back.php">Backup Master</a>
                <a href="../master/restore.php">Restore Master</a>
            </div>
        </li>
