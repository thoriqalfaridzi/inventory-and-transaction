...
$query1 = "SELECT DISTINCT item_name FROM inventory WHERE quantity > 0;";
...
$query4 = "SELECT * FROM master_supplier;";
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="text-align: center;">
              <a href="prosesretur/kelolareturbeli.php?ubah=<?php echo $result['id']; ?>" type="button" style="text-decoration: none;">
                <img src="../../IconImage/editimg.png" style="width: 20px; height: 20px;">
              </a>
              <a href="prosesretur/prosesreturbeli.php?hapus=<?php echo $result['id']; ?>" type="button" onClick="return confirm('Apakah anda yakin ingin menghapus data retur <?php echo $result['barang']; ?> tersebut???')" style="text-decoration: none;">
