...
if (isset($_GET['tambah'])) {
    ...
    $sqlfaktur = "SELECT * FROM transaksibeli WHERE nofaktur = '$nofaktur'";
...
<div id="form">
    <form method="post" action="prosesbeli.php" id="beliForm">
        ...
        <input type="text" name="kode_supplier" value="<?php echo $supplier; ?>" required readonly>
        <br>
