...
echo "Total Penjualan = Rp. " . number_format($totalPenjualan,0,',','.') . "<br>";
echo "Biaya Lain-Lain = Rp. " . number_format($totalbiaya,0,',','.') . "<br>";
echo "Laba Bersih = Rp. " . number_format($labaBersih,0,',','.');
