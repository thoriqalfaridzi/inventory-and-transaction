...
if (isset($_GET['hapus']) && $_GET['hapus'] === 'yes') {
    ...
    if (isset($_GET['nofaktur']) && isset($_GET['kode_item'])) {
        ...
        $query_get_quantity = "SELECT quantity FROM transaksibeli WHERE nofaktur = '$nofaktur' AND kode_item = '$kode_item'";
        ...
        $query = "DELETE FROM transaksibeli WHERE nofaktur = '$nofaktur' AND kode_item = '$kode_item'";
